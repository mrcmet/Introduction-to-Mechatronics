...
> - Also added: [[Forward Kinematics]] and [[Scalar and Vector]] (vector/frame on-ramps). [[Static Equilibrium]] and [[Joint Reaction Force]] were placed in `Book/Mechanics/` and are tracked in the Mechanics Sequence Tracker (built 2026-08-10).
...
> [!note] Moved to the Mechanics tracker
> [[Static Equilibrium]] and [[Joint Reaction Force]] (the L3 diagram→force step) now live in `Book/Mechanics/` and are tracked in the **Mechanics Sequence Tracker** under *Statics for Mechanisms*. [[Pin Joint]] and [[Slider Joint]] still link to [[Joint Reaction Force]] there.

| Page | Built | Reviewed | Published | Connects to |
| ---- | ----- | -------- | --------- | ----------- |
| [[Kinematic Constraint]] | 🔨 | — | — | [[Pin Joint]], [[Slider Joint]], [[Cable Constraint]], [[Linkage Constraint]], [[Mobility]] |
...
| Linkage Analysis and Mobility | 7 | 7 | 0 | 0 |
| Mechanisms and Constrained Motion | 8 | 1 | 0 | 0 |
