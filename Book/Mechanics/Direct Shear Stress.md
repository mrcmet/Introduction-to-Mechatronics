...
- The formula $\tau = V/A$ gives the *average* shear stress across the section and assumes stress is uniformly distributed:
	- A useful first approximation for bolts, pins, and rivets. The distribution is rarely uniform in practice; see [[Transverse Shear Stress in Beams]] for the parabolic profile in beam cross-sections.
...
- Shear stress appears in three important contexts: 
	- Direct shear (pins, bolts).
	- Transverse shear in beams ([[Transverse Shear Stress in Beams]]) 
	- Torsion ([[Torsional Shear Stress]]). Each has its own formula, but the same unit and physical meaning.
