...
## Definition
> [!definition]
> **Support reactions** are the forces and moments that supports exert on a beam to maintain static equilibrium under applied loads. They are found by drawing a [[Free Body Diagram]] of the entire beam and applying the three equilibrium equations: $\sum F_x = 0$, $\sum F_y = 0$, and $\sum M = 0$.
...
## Resources
- ![](https://www.youtube.com/watch?v=yIHDFRCIE-M)
- **[Engineering Toolbox — Static Equilibrium](https://www.engineeringtoolbox.com/static-equilibrium-d_1022.html)** — equilibrium conditions and sign conventions.
