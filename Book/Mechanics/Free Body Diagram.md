...
- **Steps for constructing an FBD:**
  ...
  3. Identify and draw every external force: applied loads ([[Point Load and Distributed Load]]), weight, and support reactions ([[Beam End Conditions]]).
...
## Resources
- ![](https://www.youtube.com/watch?v=9i2whIgBjiI)
- **[Engineering Toolbox — Free Body Diagrams](https://www.engineeringtoolbox.com/free-body-diagram-d_1886.html)** — illustrated examples for common loading cases.
